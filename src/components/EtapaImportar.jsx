...
export function EtapaImportar({ carregando, onImportar }) {
  ...
  return (
    <>
      ...
      >
        <b>{carregando ? "Lendo o arquivo…" : "Solte o razão aqui"}</b>
      ...
      <div className="card" style={{ marginTop: 16 }}>
        ...
        <p className="hint">
          ...
          pelo nome; se o seu sistema usa outros títulos, dá para ajustar na etapa 2.
        </p>
        <table>
          <thead>
          ...
          <tbody>
            ...
            <tr><td className="code">Dia/Mes</td><td>Filtrar o período</td><td>Não</td></tr>
